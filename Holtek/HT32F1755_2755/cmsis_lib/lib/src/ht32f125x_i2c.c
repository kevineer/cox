...
/*********************************************************************************************************//**
  * @brief  Generates STOP condition of I2C communication.
  * @param  I2Cx: where I2Cx is the selected I2C from the I2C peripheral.
  * @retval None
  ***********************************************************************************************************/
...
/*********************************************************************************************************//**
  * @brief  Enables or Disables I2C interrupts.
  * @param  I2Cx: where I2Cx is the selected I2C from the I2C peripheral.
  * @param  I2C_Int: specifies if the I2C interrupt source to be enabled or disabled.
...
/*********************************************************************************************************//**
  * @brief  Enables or Disables I2C General Call.
  * @param  I2Cx: where I2Cx is the selected I2C from the I2C peripheral.
...
/*********************************************************************************************************//**
  * @brief  Enables or Disables I2C sending acknowledgment.
  * @param  I2Cx: where I2Cx is the selected I2C from the I2C peripheral.
...
/*********************************************************************************************************//**
  * @brief  Configures own address of the specified I2C.
  * @param  I2Cx: where I2Cx is the selected I2C from the I2C peripheral.
  * @param  I2C_Address: specifies own address of I2C.
  * @retval None
  ***********************************************************************************************************/
...
/*********************************************************************************************************//**
  * @brief  Starts transmitting to target slave address.
  * @param  I2Cx: where I2Cx is the selected I2C from the I2C peripheral.
  * @param  I2C_Address: specifies the slave address which will be transmitted.
  * @param  I2C_Direction: specifies whether the Master I2C device will read or write.
  * @retval None
  ***********************************************************************************************************/
...
/*********************************************************************************************************//**
  * @brief  Sends a data word through the I2Cx peripheral.
  * @param  I2Cx: where I2Cx is the selected I2C from the I2C peripheral.
...
/*********************************************************************************************************//**
  * @brief  Returns the received data by the I2Cx peripheral.
  * @param  I2Cx: where I2Cx is the selected I2C from the I2C peripheral.
...
/*********************************************************************************************************//**
  ...
  * @param  I2Cx: where I2Cx is the selected I2C from the I2C peripheral.
  * @param  I2C_Flag: specifies the flag to be check.
  *   This parameter can be one of the following values:
...
/*********************************************************************************************************//**
  ...
  * @param  I2Cx: where I2Cx is the selected I2C from the I2C peripheral.
  * @param  I2C_Status: specifies the flag that is to be check.
  *   This parameter can be one of the following values:
...
/*********************************************************************************************************//**
  ...
  * @param  I2Cx: where I2Cx is the selected I2C from the I2C peripheral.
  * @param  I2C_Flag: specifies the flag that is to be cleared.
  *   This parameter can be one of the following values:
...
/*********************************************************************************************************//**
  * @brief  Sets the interval timing of the high period of the I2C clock.
  * @param  I2Cx: where I2Cx is the selected I2C from the I2C peripheral.
  * @param  I2C_HighPeriod: specifies the high period that is to be set.
...
/*********************************************************************************************************//**
  * @brief  Sets the interval timing of low period of the I2C clock.
  * @param  I2Cx: where I2Cx is the selected I2C from the I2C peripheral.
  * @param  I2C_LowPeriod: specifies the low period that is to be set.
      This parameter must be a number between 0 and 0xFFFF.
  * @retval None
  ***********************************************************************************************************/
