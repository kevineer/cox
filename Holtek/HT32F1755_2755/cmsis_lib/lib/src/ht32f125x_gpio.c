...
/*********************************************************************************************************//**
 * @brief Configures the direction of specified GPIO pins.
 * @param GPIOx: where GPIOx is the selected GPIO from the GPIO peripheral, x can be A or B.
...
/*********************************************************************************************************//**
 * @brief Configures the pull resistor of specified GPIO pins.
 * @param GPIOx: where GPIOx is the selected GPIO from the GPIO peripheral, x can be A or B.
 * @param GPIO_PIN: The port pins.
 *        This parameter can be any combination of GPIO_PIN_x where x can be 0 ~ 15.
...
/*********************************************************************************************************//**
 * @brief Enables or Disables the input control of specified GPIO pins.
 * @param GPIOx: where GPIOx is the selected GPIO from the GPIO peripheral, x can be A or B.
 * @param GPIO_PIN: The port pins.
 *        This parameter can be any combination of GPIO_PIN_x where x can be 0 ~ 15.
...
/*********************************************************************************************************//**
 * @brief Selects the driving current of specified GPIO pins.
 * @param GPIOx: where GPIOx is the selected GPIO from the GPIO peripheral, x can be A or B.
 * @param GPIO_PIN: The port pins.
 *        This parameter can be any combination of GPIO_PIN_x where x can be 0 ~ 15.
...
/*********************************************************************************************************//**
 * @brief Enables or Disables the open drain function of specified GPIO pins.
 * @param GPIOx: where GPIOx is the selected GPIO from the GPIO peripheral, x can be A or B.
 * @param GPIO_PIN: The port pins.
 *        This parameter can be any combination of GPIO_PIN_x where x can be 0 ~ 15.
 * @param Cmd: This parameter can be ENABLE or DISABLE.
...
/*********************************************************************************************************//**
 * @brief Sets the selected port bits of output data.
 * @param GPIOx: where GPIOx is the selected GPIO from the GPIO peripheral, x can be A or B.
...
/*********************************************************************************************************//**
 * @brief Clears the selected port bits of output data.
 * @param GPIOx: where GPIOx is the selected GPIO from the GPIO peripheral, x can be A or B.
 * @param GPIO_PIN: Specifies the port bit to be clear.
 *        This parameter can be any combination of GPIO_PIN_x where x can be 0 ~ 15.
 * @retval None
 ************************************************************************************************************/
...
/*********************************************************************************************************//**
 * @brief Sets or Clears the selected port bits of data.
 * @param GPIOx: where GPIOx is the selected GPIO from the GPIO peripheral, x can be A or B.
 * @param GPIO_PIN: Specifies the port bits.
 *        This parameter can be any combination of GPIO_PIN_x where x can be 0 ~ 15.
 * @param Status Specifies the value to be put to the selected bits.
...
/*********************************************************************************************************//**
 * @brief Puts data to the specified GPIO data port.
 * @param GPIOx: where GPIOx is the selected GPIO from the GPIO peripheral, x can be A or B.
 * @param Data: Specifies the data to be written to the port data register.
 * @retval None
 ************************************************************************************************************/
...
/*********************************************************************************************************//**
 * @brief Selects the GPIO pin to be used as EXTI channel.
 * @param Channel: Specifies the EXTI channel to be configured.
 *        This parameter can be AFIO_EXTI_CH_x where x can be 0 ~ 15.
 * @param Source: Selects the GPIO port to be used for EXTI channel.
...
/*********************************************************************************************************//**
 * @brief Gets the lock state of specified GPIO port.
 * @param GPIOx: where GPIOx is the selected GPIO from the GPIO peripheral, x can be A or B.
...
/*********************************************************************************************************//**
 * @brief Deinitializes the AFIO peripheral registers to their default reset values.
 * @retval None
 ************************************************************************************************************/
...
/*********************************************************************************************************//**
 * @brief Configures alternated mode of GPIOA with specified pins.
...
/*********************************************************************************************************//**
 * @brief Configures alternated mode of GPIOB with specified pins.
 * @param AFIO_PIN: This parameter can be any combination of AFIO_PIN_x where x can be 0 ~ 15.
 * @param AFIO_MODE: This parameter can be one of the following values:
          @arg AFIO_MODE_DEFAULT : The default I/O function
          @arg AFIO_MODE_1       : Alternated mode 1
