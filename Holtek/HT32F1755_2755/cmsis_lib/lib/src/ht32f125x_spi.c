...
/** @defgroup SPI_Private_Function_Prototype Prototypes of SPI private functions
  * @{
  */
...
/*********************************************************************************************************//**
  * @brief  Enables or Disables the SS output for the specified SPI peripheral.
  * @param  SPIx: where SPIx is the selected SPI from the SPI peripherals.
...
/*********************************************************************************************************//**
  * @brief  Enables or Disables SPI FIFO.
  * @param  SPIx: where SPIx is the selected SPI from the SPI peripherals.
...
/*********************************************************************************************************//**
  * @brief  Configures the data length for the selected SPI.
  * @param  SPIx: where SPIx is the selected SPI from the SPI peripherals.
  * @param  SPI_DataLength: specifies data length of the SPI.
  * @retval None
  ************************************************************************************************************/
...
/*********************************************************************************************************//**
  * @brief  Configures the SS pin that is driven by hardware or software.
  * @param  SPIx: where SPIx is the selected SPI from the SPI peripherals.
  * @param  SPI_SS: specifies the SPI SS pin mode.
...
/*********************************************************************************************************//**
  * @brief  Configures the SS state to by software.
  * @param  SPIx: where SPIx is the selected SPI from the SPI peripherals.
  * @param  SPI_SoftwareSS: specifies if the SPI SS to be active or inactive.
  *   This parameter can be one of the following values:
...
/*********************************************************************************************************//**
  * @brief  Sends a data word through the SPIx peripheral.
  * @param  SPIx: where SPIx is the selected SPI from the SPI peripherals.
...
/*********************************************************************************************************//**
  * @brief  Returns the received data thorugh the SPIx peripheral
  * @param  SPIx: where SPIx is the selected SPI from the SPI peripherals.
...
/*********************************************************************************************************//**
  * @brief  Sets the value of SPI FIFO Time Out.
  * @param  SPIx: where SPIx is the selected SPI from the SPI peripherals.
  * @param  SPI_Timeout: specifies the value of Time Out.
  * @retval None
  ************************************************************************************************************/
...
/*********************************************************************************************************//**
  * @brief  Enables or Disables the specified SPI interrupt.
  * @param  SPIx: where SPIx is the selected SPI from the SPI peripherals.
  * @param  SPI_Int: specifies if the SPI interrupt source to be enabled or disabled.
...
/*********************************************************************************************************//**
  ...
  * @param  SPIx: where SPIx is the selected SPI from the SPI peripherals.
  * @param  SPI_Flag: specifies the flag that is to be check.
  *   This parameter can be one of the following values:
...
/*********************************************************************************************************//**
  * @brief  Returns the status of specified SPI FIFO.
  * @param  SPIx: where SPIx is the selected SPI from the SPI peripherals.
  * @param  SPI_FIFODirection: specifies the FIFO that is to be check.
  *   This parameter can be one of the following values:
...
/*********************************************************************************************************//**
  ...
  * @param  SPIx: where SPIx is the selected SPI from the SPI peripherals.
  * @param  SPI_Flag: specifies the flag to be cleared.
  *   This parameter can be one of the following values:
  *     @arg SPI_FLAG_WC              : SPI write collision flag
  *     @arg SPI_FLAG_RO              : SPI read overrun flag
  *     @arg SPI_FLAG_MF              : SPI mode fault flag
...
/*********************************************************************************************************//**
  * @brief  Sets the trigger level of SPI FIFO .
  * @param  SPIx: where SPIx is the selected SPI from the SPI peripherals.
  * @param  SPI_FIFODirection: specifies the FIFO that is to be set.
  *   This parameter can be one of the following values:
  *     @arg SPI_FIFO_TX            : SPI Tx FIFO
  *     @arg SPI_FIFO_RX            : SPI Rx FIFO
  * @param  SPI_FIFOLevel: specifies the FIFO trigger level.
  * @retval None
  ************************************************************************************************************/
