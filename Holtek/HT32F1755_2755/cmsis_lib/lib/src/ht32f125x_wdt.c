...
/*********************************************************************************************************//**
  * @brief  Enables or Disables the WDT interrupt when WDT meets underflow or error.
...
/*********************************************************************************************************//**
  * @brief  Enables or Disables the WDT Reset when WDT meets underflow or error.
...
/*********************************************************************************************************//**
  * @brief  Enables or Disables protect mechanism of the WDT.
...
/*********************************************************************************************************//**
  * @brief  Sets Reload value of the WDT.
  * @param  WDT_WDTV : specifies the WDT Reload value.
...
/*********************************************************************************************************//**
  * @brief  Sets delta value of the WDT.
  * @param  WDT_WDTD : specifies the WDT Delta value.
  *   This parameter must be a number between 0 and 0x0FFF.
  * @retval None
  ************************************************************************************************************/
...
/*********************************************************************************************************//**
  * @brief  Sets Prescaler value of the WDT.
  * @param  WDT_PRESCALER: specifies the WDT Prescaler value.
...
/*********************************************************************************************************//**
  ...
  * @param  WDT_FLAG: specifies the flag to be check.
  *   This parameter can be one of the following values:
