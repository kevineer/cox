...
/*********************************************************************************************************//**
 * @brief Deinitializes the GPTMx peripheral registers to their default reset values.
...
/*********************************************************************************************************//**
 * @brief Initializes the GPTMx channel x output.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
...
/*********************************************************************************************************//**
 * @brief Initializes input capture of the GPTM channel.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
...
/*********************************************************************************************************//**
 * @brief Configures the GPTM to measure an external PWM signal.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param CapInit: Point to a \ref GPTM_CaptureInitTypeDef structure that contains the configuration
 *                information.
 * @retval None
...
/*********************************************************************************************************//**
 * @brief Enables or Disables GPTM counter.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
...
/*********************************************************************************************************//**
 * @brief Configures external clock mode of the GPTM. Used ITIx as the clock source.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
...
/*********************************************************************************************************//**
 * @brief Configures external clock mode of the GPTM . Used CHx as the clock source.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param Sel: Specifies the channel source.
 *        This parameter can be one of the following values:
 ...
 * @param Pol: Specifies the CHx Polarity.
 *        This parameter can be one of the following values:
...
/*********************************************************************************************************//**
 * @brief Configures external clock mode of the GPTM. Used ETI as the clock source.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
...
/*********************************************************************************************************//**
 * @brief Configures external trigger input (ETI) of the GPTMx .
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param Psc: The external Trigger Prescaler.
 *        It can be one of the following values:
 *        @arg GPTM_ETIPSC_OFF : ETI prescaler off
...
/*********************************************************************************************************//**
 * @brief Configures prescaler of the GPTMx.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param Psc: Specifies the prescaler value.
 * @param PscReloadTime: Specifies the GPTM prescaler reload time.
 *        This parameter can be one of the following values:
...
/*********************************************************************************************************//**
 * @brief Configures counter mode of the GPTMx.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param Mod: Specifies the counter mode to be used.
 *        This parameter can be one of the following values:
 ...
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param Sel: Stores the STI source.
...
/*********************************************************************************************************//**
 * @brief Configures encoder interface of the GPTMx.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param DecoderMod: Specifies the GPTMx decoder mode.
 *        This parameter can be one of the following values:
...
/*********************************************************************************************************//**
 * @brief Forces CH0OREF waveform of the GPTMx to active or inactive level.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
...
/*********************************************************************************************************//**
 * @brief Forces CH1OREF waveform of the GPTMx to active or inactive level.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param ForcedAction: Specifies the forced action to be set to the output waveform.
 *        This parameter can be one of the following values:
...
/*********************************************************************************************************//**
 * @brief Forces CH2OREF waveform of the GPTMx to active or inactive level.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param ForcedAction: Specifies the forced action to be set to the output waveform.
 *        This parameter can be one of the following values:
...
/*********************************************************************************************************//**
 * @brief Forces the GPTMx CH3OREF waveform to active or inactive level.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param ForcedAction: Specifies the forced action to be set to the output waveform.
 *        This parameter can be one of the following values:
...
/*********************************************************************************************************//**
 * @brief Enables or Disables GPTM CRR preload function.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param NewState: This parameter can be ENABLE or DISABLE.
 * @retval None
 ************************************************************************************************************/
...
/*********************************************************************************************************//**
 * @brief Enables or Disables the GPTM CHxCCR preload function.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param Channel: Specifies the GPTM channel.
 *        This parmeter can be one of the following values:
...
/*********************************************************************************************************//**
 * @brief Clears or Safeguards the CHxOREF signal when ETI is active.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param Channel: Specifies the GPTM channel.
 *        This parmeter can be one of the following values:
 *        @arg GPTM_CH_0 : GPTM channel 0
...
/*********************************************************************************************************//**
 * @brief Configures polarity of the GPTMx channel x.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param Channel: Specifies the GPTM channel.
 *        This parmeter can be one of the following values:
 *        @arg GPTM_CH_0 : GPTM channel 0
 ...
 *        @arg GPTM_CH_2 : GPTM channel 2
 *        @arg GPTM_CH_3 : GPTM channel 3
 * @param Pol: Specifies the polarity of channel x.
 *        This parmeter can be one of the following values:
 *        @arg GPTM_CHP_NONINVERTED : active high
 *        @arg GPTM_CHP_INVERTED    : active low
 * @retval None
...
/*********************************************************************************************************//**
 * @brief Enables or Disables the GPTM channel x.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param Channel: Specifies the GPTM channel.
 *        This parmeter can be one of the following values:
 *        @arg GPTM_CH_0 : GPTM channel 0
...
/*********************************************************************************************************//**
 * @brief Configures ouput mode of the GPTM.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param Channel: Specifies the GPTM channel.
 *        This parmeter can be one of the following values:
 *        @arg GPTM_CH_0 : GPTM channel 0
 ...
 *        @arg GPTM_CH_2 : GPTM channel 2
 *        @arg GPTM_CH_3 : GPTM channel 3
 * @param Mod: Specifies the GPTM output mode.
...
/*********************************************************************************************************//**
 * @brief Enables or Disables update event of the GPTM.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
...
/*********************************************************************************************************//**
 * @brief Configures UEV1G interrupt function of the GPTMx.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
...
/*********************************************************************************************************//**
 * @brief Enables or Disables hall sensor interface of the GPTMx.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param NewState: This parameter can be ENABLE or DISABLE.
 * @retval None
 ************************************************************************************************************/
...
/*********************************************************************************************************//**
 * @brief Selects one pulse mode of the GPTMx.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param NewState: This parameter can be ENABLE or DISABLE.
 * @retval None
 ************************************************************************************************************/
...
/*********************************************************************************************************//**
 * @brief Selects master trigger output source of the GPTMx.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param Sel: Specifies the master trigger output source.
...
/*********************************************************************************************************//**
 * @brief Selects slave mode of the GPTMx.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param Sel: Specifies the timer slave mode.
 *        This paramter can be one of the following values:
...
/*********************************************************************************************************//**
 * @brief Enables or Disables the master & slave GPTM synchronous function.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param NewState: This parameter can be ENABLE or DISABLE.
 * @retval None
 ************************************************************************************************************/
...
/*********************************************************************************************************//**
 * @brief Sets counter register value of the GPTMx.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
...
/*********************************************************************************************************//**
 * @brief Sets counter reload register value of the GPTMx .
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param Reload: Specifies the counter reload register new value.
 * @retval None
 ************************************************************************************************************/
...
/*********************************************************************************************************//**
 * @brief Sets channel 0 capture/compare register value of the GPTMx.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param Cmp: Specifies the CH0CCR register new value.
 * @retval None
 ************************************************************************************************************/
...
/*********************************************************************************************************//**
 * @brief Sets channel 1 capture/compare register value of the GPTMx.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param Cmp: Specifies the CH1CCR register new value.
 * @retval None
 ************************************************************************************************************/
...
/*********************************************************************************************************//**
 * @brief Sets channel 2 capture/compare register value of the GPTMx.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param Cmp: Specifies the CH2CCR register new value.
 * @retval None
 ************************************************************************************************************/
...
/*********************************************************************************************************//**
 * @brief Sets channel 3 capture/compare register value of the GPTMx .
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param Cmp: Specifies the CH3CCR register new value.
 * @retval None
 ************************************************************************************************************/
...
/*********************************************************************************************************//**
 * @brief Configures input capture prescaler.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param Channel: Specifies the GPTM channel.
 *        This parmeter can be one of the following values:
 *        @arg GPTM_CH_0 : GPTM channel 0
 ...
 *        @arg GPTM_CH_2 : GPTM channel 2
 *        @arg GPTM_CH_3 : GPTM channel 3
 * @param Psc: Specifies the input capture prescaler new value.
 *        This parameter can be one of the following values:
...
/*********************************************************************************************************//**
 * @brief Sets clock division value of the GPTMx.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param Div: Specifies the clock division value.
...
/*********************************************************************************************************//**
 * @brief Gets channel 0 capture/compare register value of the GPTM.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
...
/*********************************************************************************************************//**
 * @brief Gets channel 1 capture/compare register value of the GPTM.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
...
/*********************************************************************************************************//**
 * @brief Gets channel 2 capture/compare register value of the GPTM.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
...
/*********************************************************************************************************//**
 * @brief Gets channel 3 capture/compare register value of the GPTM.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
...
/*********************************************************************************************************//**
 * @brief Gets counter value of the GPTMx.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
...
/*********************************************************************************************************//**
 * @brief Gets prescaler value of the GPTMx.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
...
/*********************************************************************************************************//**
 * @brief Checks whether the specified GPTM flag has been set.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param GPTM_FLAG: Specifies the flag to check.
 *        This parameter can be one of the following values:
...
/*********************************************************************************************************//**
 * @brief Clears flags of the GPTMx.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param GPTM_FLAG: Specifies the flag to be cleared.
...
/*********************************************************************************************************//**
 * @brief Enables or Disables the specified interrupts of the GPTM.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param GPTM_INT: Specifies the GPTM interrupts sources to be enabled or disabled.
 *        This parameter can be any combination of the following values:
...
/*********************************************************************************************************//**
 * @brief Checks whether the GPTM interrupt has occurred.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param GPTM_INT: Specifies the GPTM interrupt source to check.
 *        This parameter can be one of the following values:
 *        @arg GPTM_INT_CH0CC     : GPTM Capture/compare 0 interrupt
 *        @arg GPTM_INT_CH1CC     : GPTM Capture/compare 1 interrupt
 *        @arg GPTM_INT_CH2CC     : GPTM Capture/compare 2 interrupt
...
/*********************************************************************************************************//**
 * @brief Clears interrupt pending bits of the GPTMx.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param GPTM_INT: Specifies the GPTM interrupt to be cleared.
 *        This parameter can be any combination of the following values:
 *        @arg GPTM_INT_CH0CC     : GPTM Capture/compare 0 interrupt
 *        @arg GPTM_INT_CH1CC     : GPTM Capture/compare 1 interrupt
 *        @arg GPTM_INT_CH2CC     : GPTM Capture/compare 2 interrupt
...
/*********************************************************************************************************//**
 * @brief Disables slave mode to clock the prescaler directly with the internal clock.
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @retval None
 ************************************************************************************************************/
 ...
 * @param GPTMx: where GPTMx is the selected GPTM from the GPTM peripheral, x can be 0 or 1.
 * @param Ch Specifies the GPTM Channel.
 *        This parmeter can be one of the following values:
 *        @arg GPTM_CH_0 : GPTM channel 0
 *        @arg GPTM_CH_1 : GPTM channel 1
 *        @arg GPTM_CH_2 : GPTM channel 2
