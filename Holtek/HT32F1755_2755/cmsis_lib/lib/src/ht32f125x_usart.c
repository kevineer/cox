...
/*********************************************************************************************************//**
 * @brief Deinitializes the USART peripheral registers, with reset USART.
...
/*********************************************************************************************************//**
 * @brief Initializes the USARTx peripheral according to the specified parameters in the USART_InitStruct.
 * @param USARTx: where USARTx is USART to select the USART peripheral.
...
/*********************************************************************************************************//**
 * @brief Initializes the USARTx peripheral Clock according to the specified parameters
...
/*********************************************************************************************************//**
 * @brief Fills each USART_SynClockInitStruct member with its default value.
 ...
 * @param USARTx: where USARTx is USART to select the USART peripheral.
 * @param USART_ModemPin: the specifies USART modem pin to be forced.
 *   This parameter can be one of the following values:
 *         @arg USART_MODEM_DTR
 *         @arg USART_MODEM_RTS
...
/*********************************************************************************************************//**
 * @brief Enables or disables the USART IrDA interface.
 * @param USARTx: where USARTx is USART to select the USART peripheral.
...
/*********************************************************************************************************//**
 * @brief Configures the USART IrDA interface..
 * @param USARTx: where USARTx is USART to select the USART peripheral.
 * @param USART_IrDAMode: specifies the USART IrDA mode.
 *   This parameter can be one of the following values:
...
/*********************************************************************************************************//**
 * @brief Sets the specified USART IrDA prescaler. 
 * @param USARTx: where USARTx is USART to select the USART peripheral.
 * @param USART_IrDAPrescaler: specifies the USART IrDA prescaler.
 * @retval None
 ************************************************************************************************************/
...
/*********************************************************************************************************//**
 * @brief Enables the IrDA transmitter ot receiver. 
 * @param USARTx: where USARTx is USART to select the USART peripheral.
 * @param USART_IrDADirection: specifies the USART IrDA direction select.
 *   This parameter can be one of the following values:
 *         @arg USART_IRDA_TX
 *         @arg USART_IRDA_RX
 * @retval None
...
/*********************************************************************************************************//**
 * @brief The RS485 transmitter enable signal polarity configuraion. 
 * @param USARTx: where USARTx is USART to select the USART peripheral.
 * @param USART_RS485Polarity: specifies the polarity of USART RS485 Tx enable signal.
 *   This parameter can be one of the following values:
...
/*********************************************************************************************************//**
 * @brief Enables or disables the USART interrupts.
 * @param USARTx: where USARTx is USART to select the USART peripheral.
 * @param USART_IER: specifies if the USART interrupt source to be enabled or disabled.
 *   This parameter can be one of the following values:
 *         @arg USART_IER_MSIE
 *         @arg USART_IER_RLSIE
...
/*********************************************************************************************************//**
 * @brief Rx FIFO Interrupt Trigger Level Configuration.
 * @param USARTx: where USARTx is USART to select the USART peripheral.
 * @param USART_RFITL: specifies the USART Rx FIFO interrupt trigger level.
 *   This parameter can be one of the following values:
 *          @arg USART_RFITL_01
 *          @arg USART_RFITL_04
 *          @arg USART_RFITL_08
...
/*********************************************************************************************************//**
 * @brief Tx FIFO Interrupt Trigger Level Configuration.
 * @param USARTx: where USARTx is USART to select the USART peripheral.
 * @param USART_TFITL: specifies the USART Tx FIFO interrupt trigger level.
 *   This parameter can be one of the following values:
 *         @arg USART_TFITL_00
 *         @arg USART_TFITL_02
 *         @arg USART_TFITL_04
...
/*********************************************************************************************************//**
 * @brief Enables or Disables the USART time out interrupt.
 * @param USARTx: where USARTx is USART to select the USART peripheral.
 * @param NewState: new state of the USART time out interrupt.
 *   This parameter can be: ENABLE or DISABLE.
 * @retval None
 ************************************************************************************************************/
...
/*********************************************************************************************************//**
 * @brief Sets the value of USART FIFO Time Out.
 * @param USARTx: where USARTx is USART to select the USART peripheral.
 * @param USART_TimeOut: specifies the value of Time Out.
 * @retval None
 ************************************************************************************************************/
...
/*********************************************************************************************************//**
 * @brief  This function is used to clear both the write and read point in Tx FIFO or Rx FIFO.
 * @param  USARTx: where USARTx is the selected USART from the USART peripherals.
 * @param  USART_FIFODirection: determines TX FIFO or Rx FIFO that is to be reset.
...
/*********************************************************************************************************//**
 * @brief  Enables or Disables the USART stick parity function.
 * @param  USARTx: where USARTx is the selected USART from the USART peripherals.
...
/*********************************************************************************************************//**
 * @brief  Configures the USART stick parity value.
 * @param  USARTx: where USARTx is the selected USART from the USART peripherals.
 * @param  USART_StickParity: specifies the USART stick parity.
 *   This parameter can be one of the following values
 *         @arg USART_STICK_LOW
