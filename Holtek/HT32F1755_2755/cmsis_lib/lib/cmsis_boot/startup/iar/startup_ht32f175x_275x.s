...
__vector_table           
        ...
        DCD  MemManage_Handler                  ; Memoty Management Fault Handler
...
ADC_IRQHandler
        ...
        PUBWEAK MCTMBRK_IRQHandler
        SECTION .text:CODE:REORDER(1)
MCTMBRK_IRQHandler
        B MCTMBRK_IRQHandler

        PUBWEAK MCTMUP_IRQHandler
        SECTION .text:CODE:REORDER(1)
MCTMUP_IRQHandler
        B MCTMUP_IRQHandler
        
        PUBWEAK MCTMTR_IRQHandler
        SECTION .text:CODE:REORDER(1)
MCTMTR_IRQHandler
        B MCTMTR_IRQHandler
        
        PUBWEAK MCTMCC_IRQHandler
        SECTION .text:CODE:REORDER(1)
MCTMCC_IRQHandler
        B MCTMCC_IRQHandler
